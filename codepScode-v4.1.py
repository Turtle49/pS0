...
max_threshold = 2000 #200 for gain = 16 # Max size of signal vectors, its modulus, to be considered signal, not noise
min_threshold_RGB = -1000 # #10 for gain = 16 threshold for **each individual channel**min_threshold_RGB = 10000000
...
nothing_counter_threshold = 6  # minimum number of readings of "nothing" before "bad" counter, bad_counter_threshold is reset.
            ...
            if data_multi[k][0] > min_threshold_RGB and data_multi[k][1] > min_threshold_RGB and data_multi[k][2] > min_threshold_RGB:
                ...
                if data_multi[k][0] == data_multi_previous[k][0] or data_multi[k][1] == data_multi_previous[k][1] or data_multi[k][2] == data_multi_previous[k][2]:
                    ...
                    if is_it_color(data_multi[k], color_ref, color_error):
                        good_counter[k] = 1 ; bad_counter[k] = 0 ; nothing_counter[k] = 0
                        ...
                        good_counter[k] = 0 ; bad_counter[k] = 1 ; nothing_counter[k] = 0
