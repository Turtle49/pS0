...
halt_pin=board.D0; halt_ = digitalio.DigitalInOut(halt_pin); halt_.direction = digitalio.Direction.INPUT; halt_.pull = digitalio.Pull.UP
...
#    if (10) > min_threshold or (2) > min_threshold or (1) > min_threshold:
    ...
    if not switch_print.value:
        ...
        if particle_arrival:
            pass
    # In case of  key #2: force basline
